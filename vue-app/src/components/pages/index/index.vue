        ...
        <div class="right">
          ...
          <div class="work">
            ...
            <div v-for="(item,index) in work.list" :key="index">
              ...
              <p class="p-2">
                <span class="bold">公司介绍：</span>{{item.companyDesc}}
              </p>
              <p class="p-2">
                <span class="bold">工作内容：</span>{{item.dutyDesc}}
              </p>
            </div>
          </div>
          <!-- 实践经历 -->
          ...
          <div class="project">
            ...
            <div v-for="(item,index) in project.list" :key="index">
              ...
              <p class="p-2">
                <span class="bold">项目介绍：</span>{{item.projectDesc}}
              </p>
              <p class="p-2">
                <span class="bold">工作内容：</span>{{item.dutyDesc}}
              </p>
  ...
  data() {
    return {
      pdf: {
        ...
        htmlTitle: "谢鑫的简历",
        nowTime: TDate,
        icon: "https://x-cdn.oss-accelerate.aliyuncs.com/img/nran_work/xiexin.xin/img/pdf.jpeg",
        doing: false,
      },
      blackMode: true, // 夜晚模式
      me: {
        avatar:
          "https://x-cdn.oss-accelerate.aliyuncs.com/img/nran_work/xiexin.xin/img/xin-avatar-2.jpg",
      ...
      interest: {
        title: " ❀ 兴趣爱好 ❀ ",
        desc: "喜欢书法、读书，游泳、爬山、平时写写技术博客，也搭建了自定义的个人博客：<a href='http://xindot.com' target='_blank'>xindot.com</a>",
      },
      eResume: {
        visible: true,
        title: " ❀ 电子简历 ❀ ",
        img: "https://x-cdn.oss-accelerate.aliyuncs.com/img/nran_work/xiexin.xin/img/1577155712.png",
      },
      intention: {
        title: " ❀ 求职意向",
        list: [
